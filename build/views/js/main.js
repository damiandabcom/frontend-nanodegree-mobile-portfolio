...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    switch(size) {
      ...
      var  getPizzaContainer = document.getElementsByClassName("randomPizzaContainer");
    for (var i = 0; i < getPizzaContainer.length; i++) {
      getPizzaContainer[i].style.width = newWidth + "%";
    }
  }
...
// Moves the sliding background pizzas based on scroll position
 function updatePositions() {
  ...
  // Moving the calculation of scrollTop out of the loop
...
//Dynamically calculates how many pizzas are needed based on the browser window viewport.
//Number of columns (based on the window width)
